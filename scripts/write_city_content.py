...
CITIES = [
    ...
    ("austin", "Austin", "Travis", "metro",
     ...
     ["marathon-pigeon-3bed-2bath-double-wide", "marathon-mallard-4bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ("seguin", "Seguin", "Guadalupe", "small-town",
     ...
     ["marathon-katy-3bed-2bath-single-wide", "marathon-dove-1bed-1bath-single-wide", "marathon-widgeon-4bed-2bath-double-wide"]),
    ("waco", "Waco", "McLennan", "metro",
     ...
     ["marathon-mallard-4bed-2bath-double-wide", "marathon-widgeon-4bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ("tyler", "Tyler", "Smith", "metro",
     ...
     ["marathon-katy-3bed-2bath-single-wide", "marathon-pigeon-3bed-2bath-double-wide", "marathon-dove-1bed-1bath-single-wide"]),
    ("el-paso", "El Paso", "El Paso", "metro",
     ...
     ["marathon-pigeon-3bed-2bath-double-wide", "marathon-mallard-4bed-2bath-double-wide", "marathon-amarillo-2bed-2bath-single-wide"]),
    ("san-antonio", "San Antonio", "Bexar", "metro",
     ...
     ["marathon-katy-3bed-2bath-single-wide", "marathon-pigeon-3bed-2bath-double-wide", "marathon-mallard-4bed-2bath-double-wide"]),
    ...
    ("mcallen", "McAllen", "Hidalgo", "metro",
     ...
     ["marathon-widgeon-4bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide", "marathon-dove-1bed-1bath-single-wide"]),
    ("victoria", "Victoria", "Victoria", "small-town",
     ...
     ["marathon-mallard-4bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide", "marathon-dove-1bed-1bath-single-wide"]),
    ("alice", "Alice", "Jim Wells", "small-town",
     ...
     ["marathon-dove-1bed-1bath-single-wide", "marathon-katy-3bed-2bath-single-wide", "marathon-amarillo-2bed-2bath-single-wide"]),
    ("pleasanton", "Pleasanton", "Atascosa", "small-town",
     ...
     ["marathon-katy-3bed-2bath-single-wide", "marathon-dove-1bed-1bath-single-wide", "marathon-pigeon-3bed-2bath-double-wide"]),
    ("amarillo", "Amarillo", "Potter", "metro",
     ...
     ["canyon"],
     ["marathon-amarillo-2bed-2bath-single-wide", "marathon-widgeon-4bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ("lubbock", "Lubbock", "Lubbock", "metro",
     ...
     ["marathon-widgeon-4bed-2bath-double-wide", "marathon-amarillo-2bed-2bath-single-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ...
    ("dallas", "Dallas", "Dallas", "metro",
     ...
     ["marathon-mallard-4bed-2bath-double-wide", "marathon-widgeon-4bed-2bath-double-wide", "marathon-pigeon-3bed-2bath-double-wide"]),
    ...
    ("lampasas", "Lampasas", "Lampasas", "small-town",
     ...
     ["marathon-coleman-3bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide", "marathon-widgeon-4bed-2bath-double-wide"]),
    ("llano", "Llano", "Llano", "small-town",
     ...
     ["marathon-mesquite-3bed-2bath-single-wide", "marathon-gadwall-3bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ("goldthwaite", "Goldthwaite", "Mills", "small-town",
     ...
     ["marathon-pearland-3bed-2bath-single-wide", "fleetwood-javelina-1bed-1bath-single-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ("brady", "Brady", "McCulloch", "small-town",
     ...
     ["marathon-grayson-4bed-2bath-double-wide", "marathon-chapman-1bed-1bath-park-model", "marathon-katy-3bed-2bath-single-wide"]),
    ("mason", "Mason", "Mason", "small-town",
     ...
     ["marathon-spoonbill-3bed-2bath-single-wide", "marathon-dove-1bed-1bath-single-wide", "marathon-widgeon-4bed-2bath-double-wide"]),
    ("junction", "Junction", "Kimble", "small-town",
     ...
     ["marathon-woodduck-3bed-2bath-double-wide", "marathon-terra-2bed-1bath-park-model", "marathon-katy-3bed-2bath-single-wide"]),
    ("burnet", "Burnet", "Burnet", "small-town",
     ...
     ["marathon-katy-3bed-2bath-single-wide", "marathon-widgeon-4bed-2bath-double-wide", "marathon-pigeon-3bed-2bath-double-wide"]),
    ("blanco", "Blanco", "Blanco", "small-town",
     ...
     ["fleetwood-moose-4bed-2bath-double-wide", "marathon-pigeon-3bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ("johnson-city", "Johnson City", "Blanco", "small-town",
     ...
     ["marathon-mallard-4bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide", "marathon-widgeon-4bed-2bath-double-wide"]),
    ("comfort", "Comfort", "Kendall", "small-town",
     ...
     ["marathon-gadwall-3bed-2bath-double-wide", "marathon-brewster-3bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ("bandera", "Bandera", "Bandera", "small-town",
     ...
     ["marathon-coleman-3bed-2bath-double-wide", "fleetwood-javelina-1bed-1bath-single-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ("hondo", "Hondo", "Medina", "small-town",
     ...
     ["fleetwood-pronghorn-4bed-2bath-double-wide", "marathon-mesquite-3bed-2bath-single-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ("devine", "Devine", "Medina", "small-town",
     ...
     ["marathon-pearland-3bed-2bath-single-wide", "marathon-terra-2bed-1bath-park-model", "marathon-dove-1bed-1bath-single-wide"]),
    ("castroville", "Castroville", "Medina", "small-town",
     ...
     ["marathon-spoonbill-3bed-2bath-single-wide", "marathon-woodduck-3bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ...
    ("new-braunfels", "New Braunfels", "Comal", "small-town",
     ...
     ["marathon-pigeon-3bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide", "marathon-mallard-4bed-2bath-double-wide"]),
    ...
    ("luling", "Luling", "Caldwell", "small-town",
     ...
     ["marathon-mallard-4bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide", "fleetwood-javelina-1bed-1bath-single-wide"]),
    ("gonzales", "Gonzales", "Gonzales", "small-town",
     ...
     ["marathon-gadwall-3bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide", "marathon-dove-1bed-1bath-single-wide"]),
    ("floresville", "Floresville", "Wilson", "small-town",
     ...
     ["marathon-woodduck-3bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide", "marathon-terra-2bed-1bath-park-model"]),
    ("smithville", "Smithville", "Bastrop", "small-town",
     ...
     ["marathon-coleman-3bed-2bath-double-wide", "marathon-brewster-3bed-2bath-double-wide", "marathon-katy-3bed-2bath-single-wide"]),
    ("elgin", "Elgin", "Bastrop", "small-town",
     ...
     ["marathon-mesquite-3bed-2bath-single-wide", "marathon-pearland-3bed-2bath-single-wide", "marathon-widgeon-4bed-2bath-double-wide"]),
...
# or two. faq: exactly 5 {q, a} items. All fresh prose — no shared templates.
CITY_COPY = {
    "austin": {
    ...
    "seguin": {
        ...
        "faq": [
            {"q": "Is a manufactured home legally the same as a mobile home?",
             "a": "Not quite — homes built before June 1976 are classified as mobile homes, and anything built after, meeting HUD code, is a manufactured home. Texas Homes Direct's inventory is all the modern classification."},
            ...
            {"q": "What's included in site setup?",
             "a": "The base pad, underpinning, and skirting, plus utility connections once those are bid — all coordinated as one project, not several separate vendors."},
            ...
            {"q": "Is the quoted price final, or does it change as the process goes on?",
             "a": "It's final. Everything itemized above is already in that number when you first see it."},
            {"q": "Who actually determines the exact utility cost for my property?",
             "a": "A contractor we send out, not a phone estimate. That's the number you approve before it's added to your financing."},
        ],
    ...
    "pleasanton": {
        ...
        "faq": [
            {"q": "Is there an actual difference between mobile homes and manufactured homes?",
             "a": "A lot of people use 'mobile home' and 'manufactured home' as if they're the same thing \u2014 legally, they're not. The dividing line is a date: homes built before June 1976 are mobile homes, and everything since, built to HUD's code, is a manufactured home."},
            ...
            {"q": "Will you handle everything, or just get the home to my lot near Pleasanton?",
             "a": "Every piece of it. Once utilities are bid, our team manages the pad, underpinning, and skirting too \u2014 one job, not a handoff between vendors near Pleasanton."},
            ...
            {"q": "Does the price I'm shown in photos match the final quote?",
             "a": "The photos show the floor plan; the final number depends on your specific selections, but everything itemized above is always included."},
            {"q": "How do you land on an exact utility number for my property?",
             "a": "A phone estimate first, then an exact bid once our contractor has actually inspected the land."},
        ],
        "lastModified": "2026-09-18",
    },
    "amarillo": {
    ...
    "new-braunfels": {
        ...
        "faq": [
            {"q": "What actually separates 'mobile home' from 'manufactured home'?",
             "a": "The construction date and code: pre-June-1976 is technically a mobile home, and anything since, built to HUD standards, is a manufactured home."},
            ...
            {"q": "Is setup part of the purchase, or something I arrange myself?",
             "a": "Part of the purchase. Utility hookups, the base pad, underpinning, and skirting for New Braunfels-area buyers are all handled by us."},
            {"q": "Can I get approved with less-than-perfect credit?",
            ...
            {"q": "Does the quoted price for a New Braunfels-area home include everything?",
             "a": "It does. Every item itemized above is already built into that number."},
            {"q": "Why can't utilities be quoted over the phone?",
             "a": "Because the real cost depends on your specific property. We start with an estimate, then get you an exact bid from a contractor who's actually been to the site."},
        ],
        "lastModified": "2026-09-18",
    },
    "lockhart": {
        ...
        "faq": [
            {"q": "Is there a real difference between mobile homes and manufactured homes?",
             "a": "There's a real legal distinction, not just old-fashioned phrasing. HUD's code took effect in June 1976 \u2014 anything built before that is a mobile home, anything since is a manufactured home."},
            ...
            {"q": "Will the price change once I've committed to a home?",
             "a": "No \u2014 the checklist above is the price. Nothing gets tacked on after the fact."},
            {"q": "How do you handle utility pricing given every lot is different?",
             "a": "We estimate over the phone first, then send a contractor to your actual property for an exact bid before that cost is added to your financing."},
        ],
        "lastModified": "2026-09-18",
    },
    "luling": {
        ...
        "faq": [
            {"q": "Mobile home versus manufactured home — is that a real distinction?",
             "a": "It is, technically: pre-1976 construction is a mobile home, and anything built since, under HUD code, is a manufactured home."},
            ...
            {"q": "Is anything left off the quoted price?",
             "a": "No — everything itemized above is already in the number we give you."},
            {"q": "Can utility costs be estimated accurately without a site visit?",
             "a": "Not precisely. We follow the phone estimate with an actual inspection from a contractor, who produces the exact number before you commit."},
        ],
        "lastModified": "2026-09-18",
    },
    "gonzales": {
        ...
        "faq": [
            {"q": "What's the technical difference between a mobile home and a manufactured home?",
             "a": "The industry treats these as two different things, split by a single date. Before June of 1976, it's a mobile home. After, built to HUD code, it's a manufactured home."},
            ...
            {"q": "Does Texas Homes Direct handle setup near Gonzales, or just delivery?",
             "a": "Everything from the base pad to skirting to getting utilities connected \u2014 it's one managed project on our end, not separate vendors you have to juggle."},
            ...
            {"q": "How exact is the utility number before your team has seen my land?",
             "a": "Think of the phone number as a placeholder, not a promise. What actually counts is the bid our contractor gives after seeing the land."},
        ],
        "lastModified": "2026-09-18",
    },
    "floresville": {
        ...
        "faq": [
            {"q": "Are mobile homes and manufactured homes really different?",
             "a": "Yes, and it's not just marketing language. June 1976 is when HUD's federal building code kicked in \u2014 homes built earlier are mobile homes, homes built to that code since are manufactured homes."},
            ...
            {"q": "Is setup included, or an extra cost near Floresville?",
             "a": "Included. Utility hookups, the base pad, underpinning, and skirting are all part of what we handle for Wilson County buyers."},
            ...
            {"q": "Is the quoted price the actual final cost?",
             "a": "Yes — everything itemized above is included, and that number doesn't change once it's quoted."},
            {"q": "Why can't Wilson County utility costs be quoted upfront?",
             "a": "Wilson County lots differ enough that a phone quote alone isn't reliable. We'll give you a starting figure over the phone, then follow up with a contractor's exact bid."},
        ],
        "lastModified": "2026-09-18",
    },
    "smithville": {
        ...
        "faq": [
            {"q": "What legally separates a mobile home from a manufactured home?",
             "a": "It's a construction-date distinction — pre-1976 is a mobile home, and post-1976, built to current HUD code, is a manufactured home."},
            ...
            {"q": "Is setup something I arrange, or does Texas Homes Direct handle it?",
             "a": "We handle it. The pad, utility hookups, underpinning, and skirting for Smithville-area buyers are all coordinated and financed together with the home."},
            ...
            {"q": "Is the price quoted for a Smithville-area home negotiable upward later?",
             "a": "No — everything itemized above is already in that number."},
            {"q": "Can utility costs be known before a site visit?",
             "a": "Only roughly, and we say so upfront. The real number comes after a contractor has physically checked out the Bastrop County site, not before."},
        ],
        "lastModified": "2026-09-18",
    },
    "elgin": {
        ...
        "faq": [
            {"q": "What's the technical difference between mobile home and manufactured home?",
             "a": "The construction date splits them: before June 1976 is a mobile home, and June 1976 onward, under HUD code, is a manufactured home."},
            ...
            {"q": "Is site setup part of the deal near Elgin, or an extra cost?",
             "a": "Part of the deal. The pad, underpinning, and skirting get quoted with the home, and utility hookups join once the site's been assessed."},
            ...
            {"q": "Does the quoted price for an Elgin-area home include everything?",
             "a": "It does — everything itemized above is already built in."},
            {"q": "How does Texas Homes Direct figure out my utility costs?",
             "a": "In two steps: a phone estimate to start, then a contractor visits your specific property for an exact figure."},
        ],
        "lastModified": "2026-09-18",
    },
    "bastrop": {
        ...
        "faq": [
            {"q": "Is 'mobile home' just an old term for 'manufactured home'?",
             "a": "Not exactly interchangeable — a mobile home was built before June 1976, and a manufactured home was built after, to HUD standards. Texas Homes Direct sells the current classification."},
            ...
            {"q": "What's actually covered when Texas Homes Direct handles setup near Bastrop?",
             "a": "The base pad, underpinning, skirting, and utility hookups once bid — a full package, not a partial one."},
            ...
            {"q": "Does the number I'm quoted grow between now and closing?",
             "a": "It shouldn't, and with us it doesn't — the figure itemized above is locked in from the first quote."},
            {"q": "Why not just publish a standard utility estimate for Bastrop County?",
             "a": "Because no standard number would be honest — lot conditions swing too widely. We'd rather send a contractor and give you a real one."},
        ],
        "lastModified": "2026-09-18",
    },
    "giddings": {
        ...
        "faq": [
            {"q": "Is a mobile home the same thing as a manufactured home?",
             "a": "Not officially — 'mobile home' covers homes built before June 1976, and 'manufactured home' covers anything built after, under HUD rules."},
            ...
            {"q": "What does Texas Homes Direct's setup service actually include near Giddings?",
             "a": "The base pad, underpinning, skirting, and utility hookups — bundled into one process instead of separate contractors you'd have to line up yourself."},
            ...
            {"q": "Is the quoted price for a Giddings-area home final?",
             "a": "Yes — everything itemized above is already built into it."},
            {"q": "Can I get an exact utility number before you've seen my property?",
             "a": "Not with certainty. We start with a phone estimate, then send a contractor out for the real, exact bid."},
        ],
        "lastModified": "2026-09-18",
    },
    "la-grange": {
        ...
        "faq": [
            {"q": "What's the dividing line between mobile and manufactured homes?",
             "a": "It comes down to when the home was built — pre-June-1976 is a mobile home, and anything since, meeting HUD standards, is a manufactured home."},
            {"q": "What does the on-site inspection actually check?",
             "a": "That the setup — pad, underpinning, utility connections, skirting — was completed correctly on your specific La Grange-area property."},
            {"q": "Who's responsible for the setup work at my La Grange property?",
             "a": "We are. Texas Homes Direct's own crews handle the pad, hookups, underpinning, and skirting rather than subcontracting it out piecemeal."},
            ...
            {"q": "Once quoted, can the price for a La Grange-area home still move?",
             "a": "No — the number reflects everything itemized above from the moment you receive it."},
            {"q": "Is it possible to get a reliable utility quote without an in-person visit?",
             "a": "No, not a reliable one. That's exactly why a contractor visit follows the initial phone estimate before anything is finalized."},
        ],
        "lastModified": "2026-09-18",
    },
    "schulenburg": {
        ...
        "faq": [
            ...
            {"q": "How is a manufactured home defined differently from a mobile home?",
             "a": "The manufacturing date matters: pre-1976 construction is a mobile home, and post-1976, under HUD standards, is a manufactured home."},
            {"q": "Are setup costs baked into the price near Schulenburg, or separate?",
             "a": "Baked in for the fixed pieces — the pad, underpinning, and skirting are quoted with the home; utility hookups join once bid."},
            ...
            {"q": "Does the quoted price hold, or should I expect changes?",
             "a": "It holds. Everything itemized above is already factored into that number."},
            {"q": "How does Texas Homes Direct handle utility costs given every lot differs?",
             "a": "A phone call gets you a ballpark. The number that ends up in your paperwork comes only after our contractor has actually seen the Fayette County property."},
        ],
        "lastModified": "2026-09-18",
    },
    "flatonia": {
        ...
        "faq": [
            {"q": "Is a mobile home legally the same as a manufactured home?",
             "a": "No, not legally — a mobile home predates June 1976, and a manufactured home is built after that date, to HUD code."},
            ...
            {"q": "Is there any fine print on the quoted price?",
             "a": "No — everything itemized above is already accounted for."},
            {"q": "How do you keep utility estimates honest across different properties?",
             "a": "By not guessing — a phone estimate starts the conversation, and an exact, contractor-verified bid follows once they've actually seen your land."},
        ],
        "lastModified": "2026-09-18",
    },
    "cuero": {
        ...
        "faq": [
            ...
            {"q": "Mobile home versus manufactured home — is there really a difference?",
             "a": "Not just semantics \u2014 there's a legal cutoff. HUD's construction code took effect in June of 1976; anything built before that point is classified as a mobile home, and everything since falls under 'manufactured home.'"},
            {"q": "Is setup handled by Texas Homes Direct near Cuero, or do I arrange it myself?",
             "a": "We handle it in full \u2014 nothing about pad prep, underpinning, skirting, or utility connections gets left for a DeWitt County buyer to coordinate on their own."},
            ...
            {"q": "Will the price for a Cuero-area home change after I commit?",
             "a": "It doesn't. What's listed above is already baked into the number we give you upfront."},
            {"q": "How does Texas Homes Direct land on an exact utility bid?",
             "a": "A phone estimate first, then an exact figure once a contractor has actually visited the property."},
        ],
        "lastModified": "2026-09-18",
    },
}
...
for slug, name, *_ in CITIES:
    ...
    assert len(copy["faq"]) in (5, 7), f"{slug}: faq must have 5 items (legacy) or 7 (with pricing/utility Q&As)"
