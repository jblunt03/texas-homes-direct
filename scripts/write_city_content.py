...
CITIES = [
    ...
    ("seguin", "Seguin", "Guadalupe", "small-town",
     ...
     ["new-braunfels", "san-marcos", "marion", "cibolo"],
...
CITY_COPY = {
    ...
    "seguin": {
        "intro": "Seguin and the rest of Guadalupe County have plenty of families weighing a manufactured home against building from scratch. Texas Homes Direct gives straight answers on cost and financing from the first conversation, without the sales pressure a lot of dealerships lean on.",
        "buying": [
        ...
        "localProof": "Guadalupe County buyers we've worked with have used a mix of family land, newly purchased lots, and land they already owned — there's no single path that's required.",
        "faq": [
    ...
    "pleasanton": {
        "intro": "Pleasanton and the rest of Atascosa County have families looking at manufactured homes as a straightforward way to get more house for the money. Texas Homes Direct lays out honest pricing and financing details before you ever commit to anything.",
        "buying": [
        ...
        "localProof": "Atascosa County buyers we've worked with have gone in both directions — single wide and double wide — depending on what their lot and their budget called for.",
        "faq": [
